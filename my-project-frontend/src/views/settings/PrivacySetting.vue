  ...
  formRef.value.validate(valid=>{
    if(valid){
      post('/api/user/change-password',form,()=>{
        ...
        /*TODO:出现逻辑问题，修改密码成功后，应该需要退出系统进行重新登录该账号*/
      })
    }
  })
}
...
<template>
  <div style="margin: auto;max-width: 600px">
    <div style="margin-top: 20px">
      <card :icon="Setting" title="隐私设置" desc="在这里设置哪些内容可以被其他人看到" v-loading="saving">
        <div class="checkbox-list">
          ...
          <el-checkbox @change="savePrivacy('email',privacy.email)"
                       v-model="privacy.email">公开展示我的电子邮件</el-checkbox>
      ...
      <card style="margin: 20px 0" :icon="Setting" title="修改密码" desc="修改密码在这里进行操作，请务必牢记密码">
        <el-form :rules="rules" label-width="100px" ref="formRef" @validate="onValidate" :model="form" style="margin: 20px">
          ...
          <div style="text-align: center">
            <el-button @click="resetPassword" :icon="Switch" type="success">立刻重置密码</el-button>
          </div>
        </el-form>
      </card>
    </div>
